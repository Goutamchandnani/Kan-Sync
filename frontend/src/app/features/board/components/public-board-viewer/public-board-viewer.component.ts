...
export class PublicBoardViewerComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.subscription.add(this.route.paramMap.subscribe(params => {
      ...
      if (this.publicId) {
        ...
        this.websocketService.emitPublicBoardJoin(this.publicId);
  ...
  ngOnDestroy(): void {
    ...
    if (this.publicId) {
      this.websocketService.emitPublicBoardLeave(this.publicId);
    }
  ...
  private setupSocketListeners(): void {
    this.subscription.add(this.websocketService.listen('public-board:column-created').subscribe((data: any) => {
    ...
    this.subscription.add(this.websocketService.listen('public-board:task-created').subscribe((data: any) => {
      if (this.board && data.boardId === this.board._id) {
    ...
    this.subscription.add(this.websocketService.listen('public-board:task-updated').subscribe((data: any) => {
      if (this.board && data.boardId === this.board._id) {
    ...
    this.subscription.add(this.websocketService.listen('public-board:task-deleted').subscribe((data: any) => {
      if (this.board && data.boardId === this.board._id) {
        this.board.columns.forEach(column => {
    ...
    this.subscription.add(this.websocketService.listen('public-board:task-moved').subscribe((data: any) => {
      if (this.board && data.boardId === this.board._id) {
    ...
    this.subscription.add(this.websocketService.listen('public-board:column-updated').subscribe((data: any) => {
      if (this.board && data.boardId === this.board._id) {
    ...
    this.subscription.add(this.websocketService.listen('public-board:column-deleted').subscribe((data: any) => {
      if (this.board && data.boardId === this.board._id) {
